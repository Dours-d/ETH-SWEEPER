...
var Slider = function Slider(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    className: _JSXStyle.dynamic([["2968093670", [disabled ? theme.palette.accents_2 : theme.palette.accents_8, disabled ? 'not-allow' : 'pointer']]]) + " " + (props && props.className != null && props.className || "slider ".concat(className))
